# <img align="left" width="100" height="100" src="../images/icon.png">PipeAndFilter API:IPipeAndFilterAggregateCondition<T> 
...
### <a id="methods-afterrunning"/>**AfterRunning(Func&lt;EventPipe&lt;T&gt;, CancellationToken, Task&gt;, String)**
