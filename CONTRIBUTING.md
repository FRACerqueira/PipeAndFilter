...
By contributing to **PipeAndFilter**, you assert that:

* The contribution is your own original work.
* You have the right to assign the copyright for the work (it is not owned by your employer, or
  you have been given copyright assignment in writing).
* You [license](LICENSE.md) the contribution under the terms applied to the rest of the PipeAndFilter project.
...
The assembly `PipeAndFilter` should have no dependencies except the .NET BCL library.
 ...
 * Through GitHub, or through the [GitHub discussions](https://github.com/FRACerqueira/PipeAndFilter/discussions) (preferred),
   you talk about a feature you would like to see (or a bug), and why it should be in PipeAndFilter.
  ...
  * Alternatively, if a feature is on the issues list with the
   [Up For Grabs](https://github.com/FRACerqueira/PipeAndFilter/labels/up-for-grabs) label,
 ...
 * You create, or update, a fork of `PipeAndFilter` under your GitHub account.
 ...
 * Once you feel it is ready, submit the pull request to the `PipeAndFilter` repository against the `main` branch
 ...
 * One of the PipeAndFilter team members, or one of the maintainers, will evaluate it within a
 ...
 * `git push origin your-branch` (origin would be your GitHub repo or `your-github-username/PipeAndFilter` in this case).
...
If you reformat code or hit core functionality without an approval from a person on the PipeAndFilter Team,
...
with permission and was edited to follow PipeAndFilter's conventions and processes.