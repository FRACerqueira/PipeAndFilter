...
namespace PipeFilterCore
{
    ...
    public interface IPipeAndFilterAfterPipe<T> : IPipeAndFilterBuild<T> where T : class
    {
        /// <summary>
        /// Add new pipe.
        /// </summary>
        ...
        IPipeAndFilterAfterPipe<T> WithCondition(Func<EventPipe<T>, CancellationToken, ValueTask<bool>> condition, string? namecondition = null);
        ...
        /// <param name="namecondition">The name for condition(optional).</param>
        /// <returns><see cref="IPipeAndFilterAfterPipe{T}"/></returns>
        IPipeAndFilterAfterPipe<T> WithGotoCondition(Func<EventPipe<T>, CancellationToken, ValueTask<bool>> condition, string aliasgoto, string? namecondition = null);
